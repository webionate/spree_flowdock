  ...
  describe '#push' do
    ...
    it 'does push a message to flowdock' do
      ...
      stub = stub_request(:post, "https://api.flowdock.com/v1/messages/team_inbox/test")
        .with(
          :body => "source=Spree%20Test%20Store&format=html&from_address=spree%40example.org&subject=New%20incoming%20order%20at%20Spree%20Test%20Store!&content=Order%20number%3A%20ABC%3Cbr%2F%3ETotal%3A%20%24100.00&from_name=Spree%20Test%20Store&tags=test%2Corder%2Cincoming%2CABC&link=www.example.com%2Fde%2Fadmin%2Forders%2FABC%2Fedit",
